...
- `.github/workflows/sync.yml` — chạy `sync_lark.py` 3 lần/ngày 09:00, 14:00, 21:00 (giờ VN) hoặc bấm tay.
...
## Cập nhật hàng ngày
Tự động chạy 3 lần/ngày lúc 09:00, 14:00, 21:00 VN (GitHub có thể trễ lịch vài giờ). Muốn cập nhật ngay: vào **Actions → Run workflow**.
